...
var ErrCode: Integer;
Begin
   {writeln('ReadReal: comment: ' + Comment + ' Str: ' + CommentStr);}
...
Begin
{   writeln('RealPlantVariables: ReadWrite='+ReadWrite);}
...
{   {DB} writeln('LoadSavePlant - before - Parameter.Transmit='+FloatToStr(Parameter.Transmit));}
   
   ProcessNext (Parameter.Transmit, 'Leaf transmissivity', 0.01, CommentStr, VarStr, ReadWrite, Defp);
{   {DB} writeln('LoadSavePlant - after - Parameter.Transmit='+FloatToStr(Parameter.Transmit));}
   
{   {DB} writeln('LoadSavePlant - before - Parameter.TMaxRepairTime='+FloatToStr(Parameter.TMaxRepairTime));}
...
{   {DB} writeln('LoadSavePlant - after - Parameter.TMaxRepairTime='+FloatToStr(Parameter.TMaxRepairTime));}
