...
Uses SysUtils, untDeclarations, untDivideValidation, untFieldValidation, untFileIO; //Dialogs;
...
For iDataSet := 1 to Obs.nDataSets do
    ...
    if Obs.DataType[iDataSet] = O_Dummy then  // did not find a matching string
       Writeln('Error! The data in the observtion file is not correct!' + chr(10) +
