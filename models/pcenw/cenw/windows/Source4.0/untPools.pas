...
For iLayer := 0 to DisplayLayers do
    Begin
    New_NandP(SoilOrganic.Struct, iLayer, OldSoil.StructLitter[iLayer]);
    New_NandP(SoilOrganic.Metab, iLayer, OldSoil.MetabLitter[iLayer]);
    If iLayer = 0 then
       New_NandP(SoilOrganic.FineWood, 0, OldSoil.FineWoodLitter[0]);
    New_NandP(SoilOrganic.CoarseWood, iLayer, OldSoil.CoarseWoodLitter[iLayer]);
    New_NandP(SoilOrganic.Active, iLayer, OldSoil.Active[iLayer]);
    New_NandP(SoilOrganic.Slow, iLayer, OldSoil.Slow[iLayer]);
    New_NandP(SoilOrganic.Resistant, iLayer, OldSoil.Resistant[iLayer]);
    New_NandP(SoilOrganic.Inert, iLayer, OldSoil.Inert[iLayer]);
    End;
...
For iLayer := 0 to DisplayLayers do
    ...
    Else
       ...
       End;
    FillEditBoxDisplay (Sender, frmPools.tbsCarbon, 50, 85, iCount, iLayer, false, SoilOrganic.Struct[iLayer, C], 1, OldSoil.StructLitter[iLayer], SumStruct);
    FillEditBoxDisplay (Sender, frmPools.tbsCarbon, 50, 170, iCount, iLayer, false, SoilOrganic.Metab[iLayer, C], 1, OldSoil.MetabLitter[iLayer], SumMetab);
    If iLayer = 0 then
       FillEditBoxDisplay (Sender, frmPools.tbsCarbon, 50, 255, iCount, iLayer, false, SoilOrganic.FineWood[0, C], 1, OldSoil.FineWoodLitter[0], SumFine);
    FillEditBoxDisplay (Sender, frmPools.tbsCarbon, 50, 340, iCount, iLayer, false, SoilOrganic.CoarseWood[iLayer, C], 1, OldSoil.CoarseWoodLitter[iLayer], SumCoarse);
    FillEditBoxDisplay (Sender, frmPools.tbsCarbon, 50, 425, iCount, iLayer, false, SoilOrganic.Active[iLayer, C], 1, OldSoil.Active[iLayer], SumActive);
    FillEditBoxDisplay (Sender, frmPools.tbsCarbon, 50, 510, iCount, iLayer, false, SoilOrganic.Slow[iLayer, C], 1, OldSoil.Slow[iLayer], SumSlow);
    FillEditBoxDisplay (Sender, frmPools.tbsCarbon, 50, 595, iCount, iLayer, false, SoilOrganic.Resistant[iLayer, C], 1, OldSoil.Resistant[iLayer], SumResistant);
    FillEditBoxDisplay (Sender, frmPools.tbsCarbon, 50, 680, iCount, iLayer, false, SoilOrganic.Inert[iLayer, C], 1, OldSoil.Inert[iLayer], SumInert);
    End;
iCount := iCount + 22;
...
For iLayer := 0 to DisplayLayers do
    ...
    Else
       ...
       End;
    FillEditBoxDisplay (Sender, frmPools.tbsNitrogen, 50, 55, iCount, iLayer, false, SoilOrganic.Struct[iLayer, N], 1, Dummy, SumStruct);
    FillEditBoxDisplay (Sender, frmPools.tbsNitrogen, 50, 140, iCount, iLayer, false, SoilOrganic.Metab[iLayer, N], 1, Dummy, SumMetab);
    If iLayer = 0 then
       FillEditBoxDisplay (Sender, frmPools.tbsNitrogen, 50, 225, iCount, iLayer, false, SoilOrganic.FineWood[0, N], 1, Dummy, SumFine);
    FillEditBoxDisplay (Sender, frmPools.tbsNitrogen, 50, 310, iCount, iLayer, false, SoilOrganic.CoarseWood[iLayer, N], 1, Dummy, SumCoarse);
    FillEditBoxDisplay (Sender, frmPools.tbsNitrogen, 50, 395, iCount, iLayer, false, SoilOrganic.Active[iLayer, N], 1, Dummy, SumActive);
    FillEditBoxDisplay (Sender, frmPools.tbsNitrogen, 50, 480, iCount, iLayer, false, SoilOrganic.Slow[iLayer, N], 1, Dummy, SumSlow);
    FillEditBoxDisplay (Sender, frmPools.tbsNitrogen, 50, 565, iCount, iLayer, false, SoilOrganic.Resistant[iLayer, N], 1, Dummy, SumResistant);
    FillEditBoxDisplay (Sender, frmPools.tbsNitrogen, 50, 650, iCount, iLayer, false, SoilOrganic.Inert[iLayer, N], 1, Dummy, SumInert);
    FillEditBoxDisplay (Sender, frmPools.tbsNitrogen, 50, 735, iCount, iLayer, false, SoilOrganic.Soluble[iLayer, N], 1, Dummy, SumMineral);
    End;
iCount := iCount + 22;
...
For iLayer := 0 to DisplayLayers do
    ...
    Else
       ...
       End;
    FillEditBoxDisplay (Sender, frmPools.tbsPhosphorus, 50, 55, iCount, iLayer, false, SoilOrganic.Struct[iLayer, P], 1, Dummy, SumStruct);
    FillEditBoxDisplay (Sender, frmPools.tbsPhosphorus, 50, 130, iCount, iLayer, false, SoilOrganic.Metab[iLayer, P], 1, Dummy, SumMetab);
    If iLayer = 0 then
       FillEditBoxDisplay (Sender, frmPools.tbsPhosphorus, 50, 205, iCount, iLayer, false, SoilOrganic.FineWood[0, P], 1, Dummy, SumFine);
    FillEditBoxDisplay (Sender, frmPools.tbsPhosphorus, 50, 280, iCount, iLayer, false, SoilOrganic.CoarseWood[iLayer, P], 1, Dummy, SumCoarse);
    FillEditBoxDisplay (Sender, frmPools.tbsPhosphorus, 50, 355, iCount, iLayer, false, SoilOrganic.Active[iLayer, P], 1, Dummy, SumActive);
    FillEditBoxDisplay (Sender, frmPools.tbsPhosphorus, 50, 430, iCount, iLayer, false, SoilOrganic.Slow[iLayer, P], 1, Dummy, SumSlow);
    FillEditBoxDisplay (Sender, frmPools.tbsPhosphorus, 50, 505, iCount, iLayer, false, SoilOrganic.Resistant[iLayer, P], 1, Dummy, SumResistant);
    FillEditBoxDisplay (Sender, frmPools.tbsPhosphorus, 50, 580, iCount, iLayer, false, SoilOrganic.Inert[iLayer, P], 1, Dummy, SumInert);
    FillEditBoxDisplay (Sender, frmPools.tbsPhosphorus, 50, 655, iCount, iLayer, false, SoilOrganic.Soluble[iLayer, P], 1, Dummy, SumMineral);
    FillEditBoxDisplay (Sender, frmPools.tbsPhosphorus, 50, 730, iCount, iLayer, false, SoilOrganic.SecondaryInorganicP[iLayer, P], 1, Dummy, SumSecondaryInorganicP);
    FillEditBoxDisplay (Sender, frmPools.tbsPhosphorus, 50, 805, iCount, iLayer, false, SoilOrganic.RockP[iLayer, P], 1, Dummy, SumRockP);
    FillEditBoxDisplay (Sender, frmPools.tbsPhosphorus, 50, 880, iCount, iLayer, false, SoilOrganic.OccludedP[iLayer, P], 1, Dummy, SumOccludedP);
    End;
iCount := iCount + 22;
...
For iLayer := 0 to DisplayLayers do
    ...
    Else
       ...
       End;
    FillEditBoxDisplay (Sender, frmPools.tbsMisc, 40, 100, iCount, iLayer, false, SoilOrganic.LitterLig[iLayer], 100, Dummy, Dummy);
    If iLayer = 0 then
       FillEditBoxDisplay (Sender, frmPools.tbsMisc, 40, 165, iCount, iLayer, false, SoilOrganic.BranchLig[iLayer], 100, Dummy, Dummy);
    FillEditBoxDisplay (Sender, frmPools.tbsMisc, 40, 230, iCount, iLayer, false, SoilOrganic.StemLig[iLayer], 100, Dummy, Dummy);
    End;
...
For iLayer := 0 to DisplayLayers do
    Begin
    GetNext(CompoCount, SoilOrganic.Struct[iLayer, C]);
    GetNext(CompoCount, SoilOrganic.Metab[iLayer, C]);
    if iLayer = 0 then
       GetNext(CompoCount, SoilOrganic.FineWood[iLayer, C]);
    GetNext(CompoCount, SoilOrganic.CoarseWood[iLayer, C]);
    GetNext(CompoCount, SoilOrganic.Active[iLayer, C]);
    GetNext(CompoCount, SoilOrganic.Slow[iLayer, C]);
    GetNext(CompoCount, SoilOrganic.Resistant[iLayer, C]);
    GetNext(CompoCount, SoilOrganic.Inert[iLayer, C]);
    CompoCount := CompoCount + 1;
    End;
...
For iLayer := 0 to DisplayLayers do
    Begin
    GetNext(CompoCount, SoilOrganic.Struct[iLayer, N]);
    GetNext(CompoCount, SoilOrganic.Metab[iLayer, N]);
    if iLayer = 0 then
       GetNext(CompoCount, SoilOrganic.FineWood[iLayer, N]);
    GetNext(CompoCount, SoilOrganic.CoarseWood[iLayer, N]);
    GetNext(CompoCount, SoilOrganic.Active[iLayer, N]);
    GetNext(CompoCount, SoilOrganic.Slow[iLayer, N]);
    GetNext(CompoCount, SoilOrganic.Resistant[iLayer, N]);
    GetNext(CompoCount, SoilOrganic.Inert[iLayer, N]);
    GetNext(CompoCount, SoilOrganic.Soluble[iLayer, N]);
    CompoCount := CompoCount + 1;
    End;
...
For iLayer := 0 to DisplayLayers do
    Begin
    GetNext(CompoCount, SoilOrganic.Struct[iLayer, P]);
    GetNext(CompoCount, SoilOrganic.Metab[iLayer, P]);
    if iLayer = 0 then
       GetNext(CompoCount, SoilOrganic.FineWood[iLayer, P]);
    GetNext(CompoCount, SoilOrganic.CoarseWood[iLayer, P]);
    GetNext(CompoCount, SoilOrganic.Active[iLayer, P]);
    GetNext(CompoCount, SoilOrganic.Slow[iLayer, P]);
    GetNext(CompoCount, SoilOrganic.Resistant[iLayer, P]);
    GetNext(CompoCount, SoilOrganic.Inert[iLayer, P]);
    GetNext(CompoCount, SoilOrganic.Soluble[iLayer, P]);
    GetNext(CompoCount, SoilOrganic.SecondaryInorganicP[iLayer, P]);
    GetNext(CompoCount, SoilOrganic.RockP[iLayer, P]);
    GetNext(CompoCount, SoilOrganic.OccludedP[iLayer, P]);
    CompoCount := CompoCount + 1;
    End;
...
Else if WaterIn <> SoilWat.TotalWater then
   ...
   If SoilWat.TotalWater > 0 then
      For iLayer := 1 to SoilWat.nLayers do
          SoilWat.Layer[iLayer].WaterContent := SoilWat.Layer[iLayer].WaterContent * WaterIn / SoilWat.TotalWater
   Else
      For iLayer := 1 to SoilWat.nLayers do
          SoilWat.Layer[iLayer].WaterContent := SoilWat.Layer[iLayer].MaxWater * WaterIn / SoilWat.MaxWater;
...
for iLayer := 0 to DisplayLayers do
    Begin
    SoilOrganic.Struct[iLayer, P] := SoilOrganic.Struct[iLayer, P] * ChangeP;
    SoilOrganic.Metab[iLayer, P] := SoilOrganic.Metab[iLayer, P] * ChangeP;
    SoilOrganic.CoarseWood[iLayer, P] := SoilOrganic.CoarseWood[iLayer, P] * ChangeP;
    SoilOrganic.FineWood[iLayer, P] := SoilOrganic.FineWood[iLayer, P] * ChangeP;
    SoilOrganic.Active[iLayer, P] := SoilOrganic.Active[iLayer, P] * ChangeP;
    SoilOrganic.Slow[iLayer, P] := SoilOrganic.Slow[iLayer, P] * ChangeP;
    SoilOrganic.Resistant[iLayer, P] := SoilOrganic.Resistant[iLayer, P] * ChangeP;
    SoilOrganic.Inert[iLayer, P] := SoilOrganic.Inert[iLayer, P] * ChangeP;
    End;
...
for iLayer := 0 to DisplayLayers do
    Begin
    SoilOrganic.Struct[iLayer, N] := SoilOrganic.Struct[iLayer, N] * ChangeN;
    SoilOrganic.Metab[iLayer, N] := SoilOrganic.Metab[iLayer, N] * ChangeN;
    SoilOrganic.CoarseWood[iLayer, N] := SoilOrganic.CoarseWood[iLayer, N] * ChangeN;
    SoilOrganic.FineWood[iLayer, N] := SoilOrganic.FineWood[iLayer, N] * ChangeN;
    SoilOrganic.Active[iLayer, N] := SoilOrganic.Active[iLayer, N] * ChangeN;
    SoilOrganic.Slow[iLayer, N] := SoilOrganic.Slow[iLayer, N] * ChangeN;
    SoilOrganic.Resistant[iLayer, N] := SoilOrganic.Resistant[iLayer, N] * ChangeN;
    SoilOrganic.Inert[iLayer, N] := SoilOrganic.Inert[iLayer, N] * ChangeN;
    End;
