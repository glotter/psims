...
If Control.IncludeIsotopes then
   Begin
   grpPhsPathway.Top := 432;
   grpC4parameters.Top := grpPhsPathway.Top;
   btnOK.Top := grpPhsPathway.Top + 32;
   btnCancel.Top := btnOK.Top;
   btnHelp.Top := btnOK.Top;
   frmPhotoSyntheticParameters.Height := 590;
   End
Else
   Begin
   grpPhsPathway.Top := 336;
   grpC4parameters.Top := grpPhsPathway.Top;
   btnOK.Top := grpPhsPathway.Top + 82;
   btnCancel.Top := btnOK.Top;
   btnHelp.Top := btnOK.Top;
   frmPhotoSyntheticParameters.Height := 515;
   End;
End;
