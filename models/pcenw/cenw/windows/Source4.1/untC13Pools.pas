...
// fill form with parameters
  ...
  For iLayer := 0 to DisplayLayers do
     ...
     Else
        ...
        End;
     FillEditBoxDisplay (frmC13Pools.tbsCarbon, 50, 85, iCount, false, Soil.Struct[iLayer, C13]);
     FillEditBoxDisplay (frmC13Pools.tbsCarbon, 50, 170, iCount, false, Soil.Metab[iLayer, C13]);
     If iLayer = 0 then
        FillEditBoxDisplay (frmC13Pools.tbsCarbon, 50, 255, iCount, false, Soil.FineWood[0, C13]);
     FillEditBoxDisplay (frmC13Pools.tbsCarbon, 50, 340, iCount, false, Soil.CoarseWood[iLayer, C13]);
     FillEditBoxDisplay (frmC13Pools.tbsCarbon, 50, 425, iCount, false, Soil.Active[iLayer, C13]);
     FillEditBoxDisplay (frmC13Pools.tbsCarbon, 50, 510, iCount, false, Soil.Slow[iLayer, C13]);
     FillEditBoxDisplay (frmC13Pools.tbsCarbon, 50, 595, iCount, false, Soil.Resistant[iLayer, C13]);
     FillEditBoxDisplay (frmC13Pools.tbsCarbon, 50, 680, iCount, false, Soil.Inert[iLayer, C13]);
     End;
...
frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[1]), Soil.Struct[0, C13], 1);
frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[2]), Soil.Metab[0, C13], 1);
frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[3]), Soil.FineWood[0, C13], 1);
frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[4]), Soil.CoarseWood[0, C13], 1);
frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[5]), Soil.Active[0, C13], 1);
frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[6]), Soil.Slow[0, C13], 1);
frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[7]), Soil.Resistant[0, C13], 1);
frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[8]), Soil.Inert[0, C13], 1);
For iLayer := 1 to DisplayLayers do
    Begin
    frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[iLayer * 8 + 2]), Soil.Struct[iLayer, C13], 1);
    frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[iLayer * 8 + 3]), Soil.Metab[iLayer, C13], 1);
    frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[iLayer * 8 + 4]), Soil.CoarseWood[iLayer, C13], 1);
    frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[iLayer * 8 + 5]), Soil.Active[iLayer, C13], 1);
    frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[iLayer * 8 + 6]), Soil.Slow[iLayer, C13], 1);
    frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[iLayer * 8 + 7]), Soil.Resistant[iLayer, C13], 1);
    frmMain.GetEdit(Sender, TEdit(frmC13Pools.tbsCarbon.Components[iLayer * 8 + 8]), Soil.Inert[iLayer, C13], 1);
    End;
