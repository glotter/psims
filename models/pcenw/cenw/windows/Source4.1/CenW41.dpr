...
uses
  ...
  untFittingParameters in 'untFittingParameters.pas' {frmFittingParameters},
  untProcessFittingData in 'untProcessFittingData.PAS',
  untFitSelect in 'untFitSelect.pas' {frmFitSelect},
  untParFitProgress in 'untParFitProgress.pas' {frmParFitProgress};

{$R *.RES}

begin
  Application.Initialize;
  Application.Title := 'CenW 4.1';
  ...
  Application.CreateForm(TfrmFittingParameters, frmFittingParameters);
  Application.CreateForm(TfrmFitSelect, frmFitSelect);
  Application.CreateForm(TfrmParFitProgress, frmParFitProgress);
  Application.Run;
end.
