...
frmMain.FillEdit(Sender, edtMatureAge, Parameter.MatureAge, 1);
frmMain.FillEdit(Sender, edtAgePower, Parameter.AgePower, 1);
frmMain.FillEdit(Sender, edtMatureSize, Parameter.MatureSize, 1);
...
frmMain.GetEdit(Sender, edtMatureAge, Parameter.MatureAge, 1);
frmMain.GetEdit(Sender, edtAgePower, Parameter.AgePower, 1);
frmMain.GetEdit(Sender, edtMatureSize, Parameter.MatureSize, 1);
