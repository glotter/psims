...
Var Active, Slow, Resist, Resid, Struct, Metab, Inert, CO2,
    ...
    RootDistributionLimit, MoveOM, SumN, WaterRatio, DecompWatLimit, ActRate, FM: Real48;
    E: ElementsUsed;
  ...
  End; {of Function 'TotalN'}
    ...
    var NAtmos, NFertiliserAvail, CriticalNActive: real48;
        jLayer: Integer;
    BEGIN
    NFertiliserAvail := 0;
    If iLayer = 0 then
    ...
    var PAtmos, PFertiliserAvail, CriticalPActive, Slow_Phosphatase, Resistant_Phosphatase, CriticalCP: real48;
    Begin
    PFertiliserAvail := 0;
    If iLayer = 0 then
