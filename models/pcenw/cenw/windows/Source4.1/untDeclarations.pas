...
//      SOMDecay6 = 0.0010428600;  // that's the value in the current 4.0 version for the constant (d-1) for slow organic matter
      ...
      type TColors = record
                    ...
                    Magenta, DarkYellow, Yellow, BrightYellow, White, Grey, DarkGrey, Orange: longint;
                    end;
...
type ElementsUsed = (C13, C, N, P);
     ...
     array365 = array[0..365] of Real48;
...
DerivedEquilType = Record
                   ...
                   ConvergP, Delta, PDelta, PRestrict: Real48;
...
DerivedType = Record
              ...
              SoilN, GrowthSheathDensity, GrazerRespiration, Dummy: real48;
              Drainage, DecompWatLimit, Disturbed: array[0..MaxSoilLayers] of real48;
              Equil: DerivedEquilType;
              LastYearsWood, LastYearsDecomp, NPPCount, Temperature: array365;
              LAI, Absorb, Intercept, NConc, PConc: array[CohortTypes] of Real48;
              Removed: TElements;
...
ListType = Record
           ...
           Trans1stNo, TransIncrement: Real48;
           TextBoxEntry: Real48;
...
EquilibriumSetup = Record
                   ...
                   MaxChangeRatio, DeltaAdjust, BoostResistant, TargetPlimit: Real48;
...
WeedType = Record
           MaxHeight, KMHeight, Senescence, AllocLeaves, KMRootPlantNUptake, KMRootPlantPUptake: Real48;
           End;
...
ParameterType = Record
        ...
        Weathering, Labile_to_Sec, Sec_to_Labile, OccludedP_rate, Phosphatase: Real48;
...
Planttype = Record
            ...
            Stocking, Height, Area, DBH, CanopyCover, kex, WeedHeight: real48;
            SapWoodAmount: array[0..MaxSapWoodYears] of real48;
            AllWoodRings: array[0..WoodRings] of real48;
            Age: LongInt;
            end;
...
type BatchType = record
                 ...
                 OldValue, NewValue: array[BatchOptions] of Real48;
                 nEnvironments: Integer;
                 EnvironmentTimes: array[1..MaxEnvironmentEvents] of LongInt;
                 CO2, Temperature, Rainfall, VP, Radn: array[1..MaxEnvironmentEvents] of real48;
                 nGrazings: Integer;
                 GrazingTimes: array[1..MaxGrazings, 1..4] of LongInt;
                 Grazed, Respired, CH4Lost: array[1..MaxGrazings] of Real48;
                 Supplement, Removed, Leached: array[1..MaxGrazings, ElementsUsed] of Real48;
                 nHarvests: Integer;
                 HarvestTimes: array[1..MaxHarvestEvents, 1..4] of LongInt;
                 WoodCut, RelativeSize, BranchesCut, WoodRemoval, FineRemoval: array[1..MaxHarvestEvents] of real48;
...
SoilWaterCategories = Record
                      Depth, Pores, MaxWater, ExtractEffort, StressSensitivity, RelEvap, WaterContent, Percolate, MaxDrainage: Real48;
                      End;
...
WeatherType = Record
              ...
              RainProb, LastMin, LastAbsHum, LastRelHum: real48;
              End;
...
SpatialType = Record
              ...
              LongInterval, LatMin, LatMax, LatInterval, WaterHold, Fertility,
              ActiveC, ActiveN, SlowC, SlowN, ResistC, ResistN: Real48;
              ShowNumeric: Boolean;
              PlantType: SpatialPlantType;
              SoilType: SpatialSoilType;
              Tmin, Tmax, Radn, Rain: Array [1..12] of Real48;
              Draw: ScreenOptions;
              End;
...
Type ObservationType = Record
             ...
             Data, Modelled, Weight: array[1..nDataSets, 1..nDataPoints] of real48;
             TimePoint: array[1..nDataSets, 1..nDataPoints] of LongInt;
             End;
...
ControlType = Record
              ...
              nYears, Year, DisplayInterval, TotalYears, DaysSinceDisk, DiskInterval, nDiskOut, nDisplays: LongInt;
              CalcType, ClimType,
...
FitParameterRecord = Record
                ...
                Mode: FittingModes;
                Focus: FittingType;
                SumOfSquares, Deviations, OldSumOfSquares, PercentChange, SensMultiplier: Real48;
                Min, Max, Initial, Varied, LastSS, Last, Best, Multiplier, deltaX: array [FittingType] of Real48;
                Choose, Optimised, Randomise: array [FittingType] of Boolean;
                Matrix: array[1..MaxParametersToFit, 1..MaxParametersToFit] of Real48;
                InverseMatrix: array[1..MaxParametersToFit, 1.. 2 * MaxParametersToFit] of Real48;
                Slopes: array[FittingType, 1..10, 1..2] of Real48;
                DiffYX, OldxVar, NewxVar: array[1..MaxParametersToFit] of Real48;
                HistoricFit: array [0..MaxFitIterations] of Real48;
                End;

EventType = Record
            nFertilisations: integer;
            FertiliseTimes: array[0..MaxFertiliseEvents, 1..4] of LongInt;
            FertiliseAmount: array[0..MaxFertiliseEvents, ElementsUsed] of real48;
            NFertiliserAdded, PFertiliserAdded: real48;
            ...
            WoodBurnSenesc, Burn_N_CRatio, Burn_P_CRatio: array[1..MaxFireEvents] of real48;
            nPloughing: Integer;
            PloughDisturbanceRecovery: Real48;
            PloughTimes: array[1..MaxPloughEvents, 1..4] of LongInt;
            PloughDepth: array[1..MaxPloughEvents] of Integer;
            Disturbance: array[1..MaxPloughEvents] of Real48;
            nOMAdditions: Integer;
            OMAdditionTimes: array[1..MaxOMAdditions, 1..4] of LongInt;
            OMAddition: array[1..MaxOMAdditions, ElementsUsed] of Real48;
            OMExtraH2O, OMLignin: array[1..MaxOMAdditions] of Real48;
            nGrazings: Integer;
            GrazingUnits: Char;
            GrazingTimes: array[1..MaxGrazings, 1..4] of LongInt;
            GrazingAmount, GrazingFractionRespired, GrazingMethaneFraction: array[1..MaxGrazings] of Real48;
            GrazingFractionRemoved, GrazingSupplement, GrazingFractionLeached: array[1..MaxGrazings, ElementsUsed] of Real48;
            nGrazings2: Integer;
            Grazing2Times: array[1..MaxGrazings, 1..4] of LongInt;
            Grazing2UpLimit, Grazing2LowLimit, Grazing2FractionRespired, Grazing2MethaneFraction: array[1..MaxGrazings] of Real48;
            Grazing2FractionRemoved, Grazing2FractionLeached: array[1..MaxGrazings, ElementsUsed] of Real48;
            nSeedings: Integer;
            SeedingTimes: array[1..MaxSeedings, 1..4] of LongInt;
            PlantsAdded: array[1..MaxSeedings] of Real48;
            BiomassAdded: array[1..MaxSeedings, ElementsUsed] of Real48;
            End;
