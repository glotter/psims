...
type
  TfrmStandParameters = class(TForm)
    ...
    edtThreeHalvesSlope: TEdit;
    Label14: TLabel;
    Label19: TLabel;
    edtRootDesicSensitivity: TEdit;
...
if Parameter.Three_Two_Power_Law <= 1 then  //some safe-guard against too low values
   Parameter.Three_Two_Power_Law := 1;
frmMain.FillEdit(Sender, edt32PowerLaw, Parameter.Three_Two_Power_Law, 1);
frmMain.FillEdit(Sender, edtThreeHalvesSlope, Parameter.Three_Two_Power_Law_Slope, 1);
...
frmMain.FillEdit(Sender, edtRootDesicSensitivity, Parameter.RootDesicSensitivity, 1);
...
if Parameter.Three_Two_Power_Law < 1 then    // safeguard against too low values
   Parameter.Three_Two_Power_Law := 1;
frmMain.GetEdit(Sender, edtThreeHalvesSlope, Parameter.Three_Two_Power_Law_Slope, 1);
...
frmMain.GetEdit(Sender, edtRootDesicSensitivity, Parameter.RootDesicSensitivity, 1);
