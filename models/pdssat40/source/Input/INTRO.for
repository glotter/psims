...
C=======================================================================
     ...
     & 'ณ                                    31 August 2005      ณ'/
      ...
      DATA ZCG/
     & '   Cropping System Model (CSM) Version 4.0.2 (2004.0)   ',
     & '                         ICASA                          ',
     & '                                                        ',
     & ' G.Hoogenboom, J.W.Jones,C.Porter,K.J.Boote,B.Batchelor,',
     & ' L.A.Hunt, P.W.Wilkens, A.J.Gijsman,U.Singh & J.W. White',
     & '                                                        ',
  ...
  100 FORMAT (10X,A1,13X,'DSSAT Version 4.0.2 Generic Input',10X,A1)
