...
C     ATYPE ( 0) = 'Applied when required             '
      ...
      ATYPE ( 8) = 'On the seed                       '
      ATYPE (11) = 'Broadcast, very poor incorporation'
      ATYPE (12) = 'Broadcast, partially incorporated '
      ATYPE (13) = 'Broadcast, moderately incorporated'
      ATYPE (14) = 'Broadcast, moderately well incorp.'
      ATYPE (15) = 'Broadcast, well incorporated      '
      ATYPE (16) = 'Broadcast, thoroughly incorporated'
      ATYPE (17) = 'Deep placement .. up to 2 cm flood'
      ATYPE (18) = 'Deep placement using pellets      '
