...
C=======================================================================
     ...
     &           IVRGRP,PATHGE,PATHEC,ECOTYP,ECONAM,ECONO,CROP,MODELV)

      IMPLICIT     NONE

      CHARACTER*1  RNMODE,BLANK
      CHARACTER*2  CROP
      CHARACTER*6  VARTY,VARNO,ERRKEY,ECOTYP,ECONO,MODELV
  ...
  100 CONTINUE
      ...
      IF (INDEX('IE',RNMODE) .GT. 0)  THEN
         ...
         IF (INDEX 
     &      ('BNPNSBTMPECHPPPRC3C4G0G1G2G3G4G5G6G7G8BRSCVBCPCBFBCOCT'
...
C
     ...
     &         VARTY,VRNAME,PATHGE,ECONO,CROP)
          NSENS = 0
          IF (INDEX('GROCSMCAN',MODELV(1:3)) .GT. 0) THEN 
     ...
     &               ECONO,IVRGRP,MODELV)
      ...
      ELSE IF (MENU .EQ. 3) THEN
          IF (INDEX 
     &       ('BNPNSBTMPECHPPPRC3C4G0G1G2G3G4G5G6G7G8BRVBCPCBFBCOCT',
     &                CROP) .GT. 0) THEN
