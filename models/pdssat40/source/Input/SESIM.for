...
C=======================================================================
     ...
     &           NSWITCH,CROP,MEHYD,MESOM, CRMODEL)
...
C
      ...
      ELSE IF (MENU .EQ. 8) THEN
          CALL SWPHOT (RNMODE,MEPHO, CRMODEL)
...
C-----------------------------------------------------------------------
  ...
  300 FORMAT (//,"Photosynthesis option 'C' must be used with ",A5, 
     &                    " model.")
...
C=======================================================================
      ...
      SUBROUTINE SWPHOT (RNMODE,MEPHO, CRMODEL)
...
C-----------------------------------------------------------------------
 ...
 4000 FORMAT (9X,'Crop model ',A5, ' requires the use of the Canopy ',
