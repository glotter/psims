...
C=======================================================================
      ...
      SUBROUTINE WEATHR (CO2ADJ,CO2FAC,DAYADJ,DAYFAC,DPTADJ,DPTFAC,
     ...
     &           CO2,WTHSTR,NEV)
      ...
      REAL    CO2,CO2ADJ(10),CO2BAS,DAYADJ(10),DPTADJ(10)
...
!  80  FORMAT (8(A6,A1,F6.2,2X))
  80  FORMAT(5(A,A,F6.2,2X),1(A,A,F6.1,2X),2(A,A,F6.2,2X))
