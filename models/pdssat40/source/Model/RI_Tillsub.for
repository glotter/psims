...
!     &               0.0458*(XN-4.0/G3)**3)*G3                
     &               0.0458*(XN-4.0/G3)**3)*(G3**0.5)  !US              
         ...
         DTILNO  = DPTILNO*ECRAT*AMIN1 (AGEFAC**2,SWTIL,TEMF,TSHOCK)
         TILNO   = TILNO + DTILNO
      ...
      SELECT CASE (ISTAGE)
        ...
        CASE (2)
          ...
          TPLAG   = TCARBO * 0.55/SLW*AMIN1 (TURFAC,NSTRES,TEMF) 
        ...
        CASE (3)
          ...
          IF (SLW .LT. 0.0055) THEN
              SLW =0.0055
          ENDIF
          TPLAG   = B*TCARBO/SLW*AMIN1(TURFAC,NSTRES,TEMF)
          TGROLF  = TPLAG  * 0.0055
          TPLA    = TPLA   + TPLAG
          TGROSTM = TCARBO - TGROLF
     ...
     &    (AGEFAC,TURFAC,TEMF))   !0.025
          ...
          IF (SUMDTT .LT. 30.0) THEN
             ...
             TGROSTM = TCARBO - TGROLF
             TPLAG   = TGROLF/0.0055*AMIN1 (TURFAC,NSTRES,TEMF)
             TPLA    = TPLA   + TPLAG
           ELSE
             TGROSTM = TCARBO
             TGROLF  = 0.0
