...
!          ENDIF
 ...
 2190     FORMAT('@YEAR DOY   DAS   DAP  DLA   DLA%   DLAI',
     &       '   DLFM   DSTM  DSDM  DSD#  DSHM  DSH#  DRTM  DRLV',
     &       '  DRLF  DASM  DPO%  CLAI   CLFM   CSTM  CSDM  CSD#',
     $       '  CSHM  CSH#  CRTM  CRLV  CRLF   CASM  CPO% ')
!        ENDIF
...
!       Convert units from g/m2 to kg/ha for output
     ...
     &      CRLF,CASM,CPPLTD
  300   FORMAT(1X,I4,1X,I3.3,3(1X,I5),1X,F5.1,1X,F6.1,2(1X,I6),1X,I5,
     &      4(1X,F5.1),
     &      4(1X,F5.2),1X,F5.1,2(1X,I6),2(1X,I5),1X,F5.0,1X,I5,1X,F5.0,
