...
C=======================================================================
      ...
      SUBROUTINE SUBSTOR(CONTROL, ISWITCH,
...
!-----------------------------------------------------------------------
      ...
      REAL, DIMENSION(NL) :: BD, DLAYR, DUL, DS, LL
...
!     from SWFACS
      ...
      CALL PT_IPSPE(FILEIO, MDATE, RWUEP1, PORMIN, RWUMX)
!      RWUEP1 = 1.5
...
C-----------------------------------------------------------------------
      ...
      SUBROUTINE PT_IPSPE(FILEIO, MDATE, RWUEP1, PORMIN, RWUMX)
