...
!-----------------------------------------------------------------------
      ...
      REAL EOP, TRAT
!      REAL KCAN, KEP; INTEGER RUN  !TEMP CHP
...
!!***********************************************************************
!!     TEMP CHP
!!     For RUN=1, use old method.  For RUN=2, use new method.
!!     For RUN=3, use newest method.  
!      SELECT CASE(RUN)            !TEMP CHP
!
!      CASE (1)                    !TEMP CHP
!!     OLD CODE:
!C       Used to be discontinuous function above 3.0.  KJB 7/11/95
!      FDINT = 1.0 - EXP(-(KCAN + 0.15) * XHLAI)  !TEMP CHP
!
!      CASE (2)                    !TEMP CHP
!      NEW CODE:
!      FDINT = 1.0 - EXP(-(KEP) * XHLAI)  

!      CASE (3)                    !TEMP CHP
!!***********************************************************************
!      NEWEST CODE:
!      KTRANS = KCAN + 0.15 (for CERES crops)
!      KTRANS = KEP (for CROPGRO crops)
