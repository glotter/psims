...
C=======================================================================
     ...
     &    ALGFIX, ALI, FNI, TOTAML)                       !Output
      ...
      REAL    SNO3(NL),FON(NL),SRAD,UREA(NL),TMIN,TMAX

      REAL DLTFUREA, DLTFNO3, DLTFNH4
      REAL DLTOXU, DLTOXH4, DLTOXN3
      REAL TMPFUREA, TMPFNO3, TMPFNH4
      REAL TMPOXU, TMPOXH4, TMPOXN3
      REAL DLTFON(NL), DLTUREA(NL),  DLTSNO3(NL),  DLTSNH4(NL)
      REAL TMPFON, TMPUREA,  TMPNO3,  TMPNH4
      REAL FAC1 
...
!     Need initialization section here 
      ...
      ALI     = 1.0   !CHP 1/11/2005
      FTI     = 1.0   !CHP 1/11/2005
      FPH     = 7.0   !CHP 1/11/2005
